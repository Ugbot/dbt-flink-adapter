...
def sync_detailed(
    ...
    *,
    ...
    """Update a session cluster
     ...
     Modify the configuration or metadata of an existing session cluster.
    This allows you to change its state, number of task managers and other configuration.
