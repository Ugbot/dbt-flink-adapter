...
class SignatureResponse:
    """
    Attributes:
        data (Signature | Unset): Contains metadata and credentials used to upload or download an artifact (e.g. a JAR
            file)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Signature | Unset
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = Signature.from_dict(_data)
