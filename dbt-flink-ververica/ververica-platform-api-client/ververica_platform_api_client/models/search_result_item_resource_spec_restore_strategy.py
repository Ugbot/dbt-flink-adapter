...
T = TypeVar("T", bound="SearchResultItemResourceSpecRestoreStrategy")


@_attrs_define
class SearchResultItemResourceSpecRestoreStrategy:
    """
    Attributes:
        kind (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_result_item_resource_spec_restore_strategy = cls(
            kind=kind,
            allow_non_restored_state=allow_non_restored_state,
        )

        search_result_item_resource_spec_restore_strategy.additional_properties = d
        return search_result_item_resource_spec_restore_strategy
