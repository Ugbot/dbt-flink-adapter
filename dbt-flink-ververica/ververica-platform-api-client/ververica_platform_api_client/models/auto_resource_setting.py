...
T = TypeVar("T", bound="AutoResourceSetting")


@_attrs_define
class AutoResourceSetting:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auto_resource_setting = cls(
            jobmanager_resource_setting_spec=jobmanager_resource_setting_spec,
            resource_plan=resource_plan,
        )

        auto_resource_setting.additional_properties = d
        return auto_resource_setting
