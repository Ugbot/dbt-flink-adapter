...
T = TypeVar("T", bound="CreateDeploymentDraftResponseSpecTemplateSpecArtifact")


@_attrs_define
class CreateDeploymentDraftResponseSpecTemplateSpecArtifact:
    """
    Attributes:
        kind (str | Unset):  Example: SQLSCRIPT.
        sql_script (str | Unset):  Example: CREATE TABLE orders (
                order_uid  BIGINT,
                product_id BIGINT,
                price      DECIMAL(32, 2),
            ...
            .
        version_name (str | Unset):  Example: vera-4.1.2-flink-1.20.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_deployment_draft_response_spec_template_spec_artifact = cls(
            kind=kind,
        ...
        create_deployment_draft_response_spec_template_spec_artifact.additional_properties = d
        return create_deployment_draft_response_spec_template_spec_artifact
