...
if TYPE_CHECKING:
    from ..models.search_result_item_resource_spec_template_spec_logging_log_4j_loggers import (
        SearchResultItemResourceSpecTemplateSpecLoggingLog4JLoggers,
    )
    from ..models.search_result_item_resource_spec_template_spec_logging_log_reserve_policy import (
        SearchResultItemResourceSpecTemplateSpecLoggingLogReservePolicy,
    )


T = TypeVar("T", bound="SearchResultItemResourceSpecTemplateSpecLogging")


@_attrs_define
class SearchResultItemResourceSpecTemplateSpecLogging:
    """
    Attributes:
        logging_profile (str | Unset):
        log_4_j_loggers (SearchResultItemResourceSpecTemplateSpecLoggingLog4JLoggers | Unset):
        log_reserve_policy (SearchResultItemResourceSpecTemplateSpecLoggingLogReservePolicy | Unset):
    """

    logging_profile: str | Unset = UNSET
    log_4_j_loggers: SearchResultItemResourceSpecTemplateSpecLoggingLog4JLoggers | Unset = UNSET
    log_reserve_policy: SearchResultItemResourceSpecTemplateSpecLoggingLogReservePolicy | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_log_4_j_loggers, Unset):
            ...
            log_4_j_loggers = SearchResultItemResourceSpecTemplateSpecLoggingLog4JLoggers.from_dict(_log_4_j_loggers)
        ...
        if isinstance(_log_reserve_policy, Unset):
            ...
            log_reserve_policy = SearchResultItemResourceSpecTemplateSpecLoggingLogReservePolicy.from_dict(
                _log_reserve_policy
            )

        search_result_item_resource_spec_template_spec_logging = cls(
            logging_profile=logging_profile,
            log_4_j_loggers=log_4_j_loggers,
            log_reserve_policy=log_reserve_policy,
        )

        search_result_item_resource_spec_template_spec_logging.additional_properties = d
        return search_result_item_resource_spec_template_spec_logging
