...
T = TypeVar("T", bound="FolderItemResourceLock")


@_attrs_define
class FolderItemResourceLock:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folder_item_resource_lock = cls(
            holder_id=holder_id,
            holder_name=holder_name,
            modified_at=modified_at,
        )

        folder_item_resource_lock.additional_properties = d
        return folder_item_resource_lock
