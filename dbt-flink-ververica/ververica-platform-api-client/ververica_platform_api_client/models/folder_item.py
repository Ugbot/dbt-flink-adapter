...
if TYPE_CHECKING:
    from ..models.folder_item_resource import FolderItemResource
...
class FolderItem:
    ...
    Attributes:
        ...
        resource (FolderItemResource | Unset):
    """

    id: UUID | Unset = UNSET
    type_: str | Unset = UNSET
    name: str | Unset = UNSET
    resource: FolderItemResource | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = FolderItemResource.from_dict(_resource)
