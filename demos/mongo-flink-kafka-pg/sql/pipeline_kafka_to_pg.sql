-- =============================================================================
-- Job 2: Kafka → PostgreSQL (continuous streaming)
-- Reads from Kafka topics and writes to PostgreSQL via JDBC.
...
-- Kafka source tables (reading from topics written by Job 1)
...
-- Start continuous streaming: Kafka → PostgreSQL
